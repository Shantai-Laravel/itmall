...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/admin/css/normalize.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('public/admin/css/vendor.css') }}">
    <link rel="stylesheet" href="{{ asset('public/admin/css/app-green.css') }}">
    <link rel="stylesheet" href="{{ asset('public/admin/css/datepicker.css') }}">

    <script src="//ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script src="//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    <script src="{{asset('public/admin/js/datepicker.js')}}"></script>
    <script src="{{asset('public/admin/js/jquery-ui.js')}}"></script>
    <script src="{{asset('public/admin/js/toastr.js')}}"></script>
    <script src="{{asset('public/admin/js/jquery.tablednd_0_5.js')}}"></script>
    <script src="{{asset('public/admin/js/custom.js')}}"></script>
    <script src="{{asset('js/ckeditor/ckeditor.js')}}"></script>
    <script src="{{asset('public/admin/js/jquery.mjs.nestedSortable.js')}}"></script>
