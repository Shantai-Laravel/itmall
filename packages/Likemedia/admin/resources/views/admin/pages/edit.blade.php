            ...
            <div class="col-md-6">
                <div class="multiDataWrapp show" >
                    ...
                    <div class="form-group" data-id="{{ $multidata->number }}">
                        ...
                        <textarea type="text" name="case_{{ $lang->lang }}[{{ $multidata->number }}]"  class="form-control small-text">{{ $multidata->translationByLanguage($lang->id, $multidata->id) ? $multidata->translationByLanguage($lang->id, $multidata->id)->value: '' }}</textarea></i>
                    </div>
                    <hr>
                    @endforeach
                    @else
